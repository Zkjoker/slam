...
slam_types = ["全部", "基于滤波器", "特征法", "直接法", "多传感器融合","RGB-D传感器","激光雷达传感器"]
...
algo2image = {algo:"zkjoker/image1:19-12-30" for algo in ["dso", "svo", "okvis", "orb_slam", "lsd_slam", "ice_ba"]}
...
algo2datasets = {"vins_mono":["euroc", "eth-aslcla", "ar_box"],
                 ...
                 "hector_slam":["control instructions"],
                 "cartographer":["control instructions"]}
